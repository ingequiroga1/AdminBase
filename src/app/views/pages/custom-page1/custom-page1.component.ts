...
export class CustomPage1Component implements OnInit, AfterViewChecked {
  ...
  createForm(){
    this.userForm = this.fb.group({
      ...
      street:[this.usermovenco.userStreet],
      exteriorNumber:[this.usermovenco.userExteriorNumber],
      interiorNumber:[this.usermovenco.userInteriorNumber],
      zipCode: [this.usermovenco.userZipCode],
      neighborhood:[this.usermovenco.userStreet],
      state:[this.usermovenco.userState],
      city:[this.usermovenco.userCity],
